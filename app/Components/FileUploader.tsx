...
const FileUploader = ( {onFileSelect} : FileUploaderProps) => {
    ...
    <div className='w-full gradient-border cursor-pointer'>
        <div {...getRootProps()}>
            <input key={resetKey} {...getInputProps()} />
            ...
            {file ? (
                <div className='uploader-selected-file' onClick={(e)=>e.stopPropagation()}>
                    ...
                    <button
                        ...
                        className="p-2 cursor-pointer rounded hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
                        onClick={(e) => {
                            e.stopPropagation();
